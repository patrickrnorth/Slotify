	...
	<div id="mainContainer">
		<div id="topContainer">
			<div id="navBarContainer">
				...
				<div class="navItem">
					...
					<div class="navItem">
						<a href="profile.php" class="navItemLink">Ryan North</a>
					</div>
				</div>
		...
		<div id="nowPlayingBarContainer">
			<div id="nowPlayingBar">
				...
				<div class="content">
					<span class="albumLink"><img src="assets/images/testBox.png" class="albumArtwork"></span>
				...
				<div id="nowPlayingRight">
					<div class="volumeBar">
						<button class="controlButton volume" title="Volume Button">
							<img src="assets/images/icons/volumeBtn.png" alt="Volume">
						</button>
